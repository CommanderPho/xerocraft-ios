...
@interface MemberDetailsTVC ()

@property (strong, nonatomic) IBOutlet UITableView *detailTableView;

@end

@implementation MemberDetailsTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) str = [NSString
        stringWithFormat:@"%@ %@",
        [self.memberJson valueForKey:@"first_name"],
        [self.memberJson valueForKey:@"last_name"]];
